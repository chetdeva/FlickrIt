...
class RecyclerViewScrollCallback(
    ...
    override fun onScrolled(view: RecyclerView?, dx: Int, dy: Int) {
        ...
        // If it’s still showLoader, we check to see if the dataset count has
        // changed, if so we conclude it has finished showLoader and update the current page
        ...
        // If it isn’t currently showLoader, we check to see if we have breached
