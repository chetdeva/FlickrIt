...
public class ImageFetcher extends ImageResizer {
    ...
    */
    ...
    private static volatile ImageFetcher sImageFetcher;
    private static final Object LOCK = new Object();

    public static ImageFetcher getInstance(Context context, int imageHeight, int imageWidth) {
        if (sImageFetcher == null) {
            synchronized (LOCK) {
                ...
                if (sImageFetcher == null) {
                    sImageFetcher = new ImageFetcher(context, imageHeight, imageWidth);
                }
            }
        }
